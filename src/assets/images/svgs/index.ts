...
export const SVGS = { ArrowDownIcon, AccordianArrowIcon, CardOneIcon, CardTwoIcon, CardThreeIcon, CardFourIcon, AccordOneNFiveIcon, AccordTwoNFourIcon, AccordThreeIcon }