  ...
  return (
    <div>
      <div
        ...
        className='cursor-pointer relative z-2 bg-slate-50 md:hover:-translate-y-1 md:transition md:ease-in-out md:duration-500 md:w-266 w-347 md:h-232  h-24 border border-solid border-primary-ligh-white rounded-lg'
      >
        <div className='flex gap-4 justify-between flex-col h-full'>
          ...
          <div className='md:block hidden'>
            <button
              ...
              } z-4 relative h-56 bg-primary-ligh-white hover:bg-primary-yellow-dark px-6 py-4 flex items-center justify-center gap-4 rounded-tr-32`}
              type='button'
      ...
      <div
        className={`px-8 md:hidden min-h-6  w-347 -translate-y-4 relative bg-primary-yellow-light rounded-br-2xl rounded-bl-2xl ${
          !(id === active)
            ? 'z-1'
